...
all_scores = pd.DataFrame(columns=['Model', 'Score LOPO 1', 'Score LOPO 2', 'Score LOPO 3', 'Average LOPO Score', 
                                   'K-Fold Score 1', 'K-Fold Score 2', 'K-Fold Score 3', 'K-Fold Score 4', 
                                   'Average K-Fold Score', 'Average K-Fold Score Participant 1', 'Average K-Fold Score Participant 2', 'Average K-Fold Score Participant 3' ])
...
all_scores.to_csv("Wrist and Waist Model Scores.csv", index=False)
